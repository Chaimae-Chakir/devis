...
public class DevisPdfGenerator {
    ...
    private void addHeader(Document document, Devis devis) throws DocumentException {
    ...
    private void addClientInfo(Document document, Devis devis) throws DocumentException {
        PdfPTable table = new PdfPTable(2);
        table.setWidthPercentage(100);
    ...
    private void addClientCell(PdfPTable table, String label, String value) {
        if (value != null) {
    ...
    private void addPrestationsTable(Document document, Devis devis) throws DocumentException {
    ...
    private void addMetaContent(Document document, Devis devis) throws DocumentException {
    ...
    private void addFooter(Document document, Devis devis) throws DocumentException {
