...
public class DevisPdfGeneratorImpl {
    ...
    public byte[] generateDevisPdf(Long devisId) throws Exception {
        Devis devis = devisRepository.findById(devisId)
                .orElseThrow(() -> new IllegalArgumentException("Devis not found with id: " + devisId));
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            log.error("Error generating PDF for devis {}", devisId, e);
